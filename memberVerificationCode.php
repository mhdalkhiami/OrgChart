    ...
    <div class="row m-0 justify-content-center">
        <div class="col-md-12" align="center" style="padding-top:100px">
            ...
            <div class="col-md-12" align="center">
                <button class="btn btn-default btn-cons m-t-rem2 btnCustomWidth" onclick="window.location.href='memberLogin.php'">Back</button>
        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success btn-cons btnCustomWidth" onclick="window.location.href='memberPageListView.php'">
                        Get started
                    </button>
                </div>
            </div>
