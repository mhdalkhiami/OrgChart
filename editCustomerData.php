...
<div class="" >
			...
			<div class="card-block d-flex justify-content-between">
				<div class="col-md-12" style="padding: 25px;">
					...
					<div class="col-lg-12 mt-4 mobileNoPadding">
						<button class="btn btn-success btn-cons m-t-rem2 btnCustomWidth" data-toggle="modal" data-target="#editData">Next</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="modal fade stick-up " id="editData" tabindex="-1" role="dialog">
			...
			<div class="modal-content-wrapper">
				<div class="modal-content">
					...
					<div class="modal-body text-center">
						<h5>You had updated customer details.</h5>
					</div>
