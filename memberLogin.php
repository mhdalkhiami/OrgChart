                        ...
                        <form class="loginFormCustom" method="POST" id="form1">
                            ...
                            <div class="col-md-12 row mx-0">
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-6">
                                    <a href="memberForgotPassword.php" class="forgotPassword">Forgot password?</a>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-6 hidden-xs hidden-sm">
                                    <a href="memberPublicRegistration.php" class="signUp">Sign Up<i class="fa fa-long-arrow-right"></i></a>
                                </div>

                                <div class="col-md-12" style="padding-top:20px"><a href="memberPublicRegistration.php" class="phoneSign" >Not Member? Sign Up Here <i class="fa fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
