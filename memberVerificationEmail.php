    ...
    <div class="row m-0 justify-content-center">
        <div class="col-md-12" align="center" style="padding-top:100px">
            ...
            <div class="block successBlock" align="center">
             ...
             <p><b>Pin number had been sent to "test@gmail.com"</b></p>
             <p>Please enter the Pin number below to verify your account</p>
        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-body" align="center">
                    <p><b>Thank you for verifying your Pin number.</b></p>
